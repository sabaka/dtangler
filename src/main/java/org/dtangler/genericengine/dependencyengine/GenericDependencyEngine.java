...
public class GenericDependencyEngine extends AbstractDependencyEngine {
	...
	private static Scope getDefaultScope(Arguments arguments, ValidScopes validScopes) {
	...
	private static boolean readFromStandardInput(Arguments arguments) {
	...
	private static Set<Item> getItems(Arguments arguments,
	...
	private static Set<File> getInputFiles(Arguments arguments) {
