...
public class Arguments {
	...
	/**
	 * Contains the path(s) to the items that are being analyzed for dependencies.
	 */
	private List<String> input = Collections.EMPTY_LIST;

	/**
	 * Logical groups of items that can be used, for example, in rule definitions.
	 */
	private Map<String, Group> groups = Collections.EMPTY_MAP;

	/**
	 * Defines whether cyclic dependencies will fail the build. The default value is false.
	 */
	private boolean cyclesAllowed = false;

	/**
	 * Maps forbidden dependencies. The items on the key side can not depend on any items on the right side.
	 */
	private Map<String, Set<String>> forbiddenDependencies = Collections.EMPTY_MAP;

	/**
	 * Maps allowed dependencies. As opposed to forbidden dependencies, these override any possible forbidden
	 * dependency.
	 */
	private Map<String, Set<String>> allowedDependencies = Collections.EMPTY_MAP;

	/**
	 * file masks that are ignored when scanning the input paths. Masks are case sensitive and can contain multiple '*'
	 * wildcards
	 */
	private List<String> ignoredFileMasks = Collections.EMPTY_LIST;

	/**
	 * Defines the analyzing scope. This parameter is interpreted by the frontend used.
	 */
	...
	/**
	 * The id of the dependency engine. The default value is DependencyEngineFactory.DEFAULT_DEPENDENCY_ENGINE_ID
	 */
	...
	private static Map<String, Group> createGroupDeepCopy(Map<String, Group> orig) {
	...
	private static Map<String, Set<String>> createDeepCopy(
	...
	private static boolean nullSaveEquals(Object o1, Object o2) {
		if (o1 == null) {
			return o2 == null;
		}
		return o1.equals(o2);
	...
	private static int nullSaveHashCode(Object obj) {
